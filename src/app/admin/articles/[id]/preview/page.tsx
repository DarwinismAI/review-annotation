 ...
 * resolve to numbered pills with hover tooltips. Mirrors the expert review's
...
/**
 * Stars that look + feel exactly like the expert's rubric stars (hover, click,
      ...
      <div className="bg-amber-100 border-b border-amber-300 h-11 px-6 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2 text-amber-800">
          ...
          <span className="text-sm font-semibold">
            Đang preview như chuyên gia — Read-only mode. Mọi thay đổi sẽ không được lưu.
              ...
              <div>
                ...
                <div className="space-y-1.5 text-xs text-slate-600">
                  {data.assignment ? (
                    <>
                      <p>
                        Chuyên gia: <strong>{data.assignment.expertName ?? "—"}</strong>
                      </p>
                      <p>
                                ...
                                {dbRatings.map((dr) => {
                                  ...
                                  return (
                                    <span
                                      ...
                                      title={dr.expertName ?? "Chuyên gia"}
                                    >
